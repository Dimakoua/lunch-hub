...
export const RandomPicker: React.FC<RandomPickerProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      <div className="bg-white rounded-xl shadow-lg p-8 min-h-[300px] w-full max-w-md flex flex-col items-center justify-center">
        {!selectedRestaurant ? (
          ...
          <div className={`text-center w-full ${isAnimating ? 'animate-pulse' : 'animate-fadeIn'}`}>
            <div className="w-16 h-16 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center mb-4 mx-auto">
            ...
            {selectedRestaurant.cuisine && (
              <span className="inline-block text-sm bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full mb-3">
                {selectedRestaurant.cuisine}
              </span>
            )}
      ...
      <div className="flex gap-4">
        <button
          ...
          className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-400 text-white px-8 py-3 rounded-lg font-medium transition-all duration-200 flex items-center gap-2 transform hover:scale-105"
        >
        ...
        {selectedRestaurant && !isAnimating && (
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 flex items-center gap-2"
          >
            View Details
